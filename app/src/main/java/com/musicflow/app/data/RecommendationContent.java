 ...
 * 
 * This class holds the logic to correctly deserialze the contained content based on a specific
 * value of the "type" attribute. Depending on the type a different class is used to deserialze so
 * that we can properly automatically map the right fields.
 */
 ...
 */
@JsonSubTypes({@JsonSubTypes.Type(value = AlbumRecommendationContent.class, name = "album"),
